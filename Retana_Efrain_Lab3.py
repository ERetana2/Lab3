...
if __name__ == "__main__":
    ...
    L1.append(0)
    end_time = time.time()
    print('Append Total Process Time:' , (end_time - start_time))
    L1.draw('Append')
    # EXTEND 2
    start_time = time.time()
    ...
    L1.insert(5,8)
    end_time = time.time()
    print('Insert Total Process Time:', (end_time - start_time))
    L1.draw('Insert')
    # REMOVE 4
    start_time = time.time()
    L1.remove(1)
    end_time = time.time()
    print('Remove Total Process Time:', (end_time - start_time))
    L1.draw('Remove')
    # POP 5a
    start_time = time.time()
    print(L1.pop(2))
    end_time = time.time()
    print('Pop Total Process Time: ' , (end_time - start_time))
    L1.draw('Pop a')
    # POP 5b
    start_time = time.time()
    print(L1.pop())
    ...
    print(L1.index(2))
    end_time = time.time()
    print('Index Total Process Time:', (end_time - start_time))
    # INDEX 7b
    start_time = time.time()
    print(L1.index(6,2,5))
    end_time = time.time()
    print('Index From Total Process Time:' , (end_time - start_time))
    #COUNT 8
    start_time = time.time()
    print(L1.count(4))
    end_time = time.time()
    print('Count Total Process Time:' , (end_time - start_time))
    # SORT 9
    start_time = time.time()
    L1.sort()
    end_time = time.time()
    print('Sort Total Process Time:', (end_time - start_time))
    L1.draw('Sorted List')
    # REVERSE 10
    start_time = time.time()
    L1.reverse()
    end_time = time.time()
    print('Reverse Total Process Time:',(end_time - start_time))
